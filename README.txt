...
- For making this model to inference one need to install all requirements which are listed in requirement.txt and trained weighted located in weights directory. 
